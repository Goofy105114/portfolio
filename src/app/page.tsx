...
const projects = [
  ...
  { number: "02", category: "PROTOTYPE", title: "MatsyaSetu App Prototype", description: "An early Flutter prototype from the MatsyaSetu project direction.", tags: ["Dart", "Flutter"], href: "https://github.com/Goofy105114/MatsyaSetu-App-Prototype-", code: "prototype.render('matsyasetu');" },
  { number: "03", category: "AI / NLP", title: "Python Chatbot", description: "A conversational Python project using natural language toolkit ideas.", tags: ["Python", "NLTK"], href: "https://github.com/Goofy105114/python-chatbot", code: "bot.listen(message);" },
  { number: "04", category: "SYSTEMS", title: "API Gateway System", description: "A project exploring API gateway architecture and service boundaries.", tags: ["Jupyter", "APIs"], href: "https://github.com/Goofy105114/API-GATEWAY-SYSTEM-PROJECT", code: "gateway.route(request);" },
  { number: "05", category: "DATA / HEALTH", title: "HealthSecure", description: "A blockchain-based medical record system exploring decentralized data integrity.", tags: ["Python", "Streamlit"], href: "https://github.com/Goofy105114/health-blockchain", code: "records.verify_integrity();" },
  { number: "06", category: "FULL-STACK", title: "Machine Link", description: "A JavaScript project exploring application development and interaction.", tags: ["JavaScript", "Web"], href: "https://github.com/Goofy105114/machine-link-project", code: "machine.connect(user);" },
];
...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="contact section-wrap" id="contact"><div className="section-kicker warm">10 / Start a conversation</div><h2>Have an idea<br /><em>worth building?</em></h2><p>I&apos;m always interested in interesting problems, ambitious projects, and people building something meaningful.</p><a className="contact-email" href="mailto:ankit105114@gmail.com">ankit105114@gmail.com <Arrow /></a><div className="contact-footer"><span>ANKIT VERMA / GOOFY</span><div><a href="https://github.com/Goofy105114" target="_blank" rel="noreferrer">GitHub</a><a href="https://www.linkedin.com/in/ankitverma10/" target="_blank" rel="noreferrer">LinkedIn</a><a href="https://www.youtube.com/@Gigcel" target="_blank" rel="noreferrer">YouTube / GIGCEL</a></div><small>© 2026 / Built with curiosity.</small></div></section>
    </main>
  );
}
